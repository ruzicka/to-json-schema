...
// const validator = require('../../src/validator').createValidator({arrayMerge: false})
// const validatorMerge = require('../../lib/validator').createValidator({arrayMerge: true})
...
//
//
// function stringFormatsTest(myValidator) {
...
// }
//
// function reverseStringFormatTest(myValidator) {
...
// 					schema.should.deep.equal({type: 'string', format: formatName, required: true})
// 					return myValidator.isValid(item, item).should.be.true
// 				})
// 			})
// 		})
// 	})
...
// 		stringFormatsTest(validator)
// 		stringFormatsTest(validatorMerge)
// 	})
//
// 	describe('String format reverse discovery', () => {
// 		reverseStringFormatTest(validator)
// 		reverseStringFormatTest(validatorMerge)
// 	})
//
// })
